...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText1 = findViewById(R.id.test1);
        editText2 = findViewById(R.id.test2);
        editText3 = findViewById(R.id.test3);
    }
    ...
    public void request(){
        ...
        try {
            ...
            testjson.put("id", editText2.getText().toString());
            testjson.put("password", editText3.getText().toString());
